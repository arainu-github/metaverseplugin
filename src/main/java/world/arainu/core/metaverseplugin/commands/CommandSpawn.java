...
public class CommandSpawn extends CommandPlayerOnlyBase {
    ...
    public boolean execute(Player player, Command command, String label, String[] args) {
        if (args.length == 1) {
            switch (args[0]) {
                case "mason-villager" -> {
                    Villager villager = createVillager("鉱石マン", Villager.Profession.MASON, player);
                ...
                case "mason-villager-shop" -> {
                    Villager villager = createVillager("お金マン(鉱石)", Villager.Profession.MASON, player);
                    sqlUtil.setuuidtype(villager.getUniqueId(), args[0]);
                    List<MerchantRecipe> recipes = new ArrayList<>();
                ...
                case "stone-villager" -> {
                    Villager villager = createVillager("石工マン", Villager.Profession.MASON, player);
                    sqlUtil.setuuidtype(villager.getUniqueId(), args[0]);
                    List<MerchantRecipe> recipes = new ArrayList<>();
                ...
                case "stone-villager-shop" -> {
                    Villager villager = createVillager("お金マン(石系)", Villager.Profession.MASON, player);
                    sqlUtil.setuuidtype(villager.getUniqueId(), args[0]);
                    List<MerchantRecipe> recipes = new ArrayList<>();
                ...
                case "money-villager" -> {
                    Villager villager = createVillager("両替マン", Villager.Profession.TOOLSMITH, player);
                    sqlUtil.setuuidtype(villager.getUniqueId(), args[0]);
                    List<MerchantRecipe> recipes = new ArrayList<>();
