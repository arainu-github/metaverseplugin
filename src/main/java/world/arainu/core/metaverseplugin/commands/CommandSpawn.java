        ...
        if (args.length == 1) {
            switch (args[0]) {
                ...
                case "mob-villager" -> {
                    ...
                    sqlUtil.setuuidtype(villager.getUniqueId(), args[0]);
                    List<MerchantRecipe> recipes = new ArrayList<>();
                    recipes.add(createRecipe(500, 1, new ItemStack(Material.AXOLOTL_SPAWN_EGG)));
                    recipes.add(createRecipe(500, 1, new ItemStack(Material.BAT_SPAWN_EGG)));
                    recipes.add(createRecipe(500, 1, new ItemStack(Material.BEE_SPAWN_EGG)));
                    recipes.add(createRecipe(500, 1, new ItemStack(Material.CAT_SPAWN_EGG)));
                    recipes.add(createRecipe(500, 1, new ItemStack(Material.CHICKEN_SPAWN_EGG)));
                    recipes.add(createRecipe(500, 1, new ItemStack(Material.COD_SPAWN_EGG)));
                    recipes.add(createRecipe(500, 1, new ItemStack(Material.COW_SPAWN_EGG)));
                    recipes.add(createRecipe(500, 1, new ItemStack(Material.DOLPHIN_SPAWN_EGG)));
                    recipes.add(createRecipe(500, 1, new ItemStack(Material.DONKEY_SPAWN_EGG)));
                    recipes.add(createRecipe(500, 1, new ItemStack(Material.FOX_SPAWN_EGG)));
                    recipes.add(createRecipe(500, 1, new ItemStack(Material.HORSE_SPAWN_EGG)));
                    recipes.add(createRecipe(500, 1, new ItemStack(Material.LLAMA_SPAWN_EGG)));
                    recipes.add(createRecipe(500, 1, new ItemStack(Material.OCELOT_SPAWN_EGG)));
                    recipes.add(createRecipe(500, 1, new ItemStack(Material.PARROT_SPAWN_EGG)));
                    recipes.add(createRecipe(500, 1, new ItemStack(Material.PANDA_SPAWN_EGG)));
                    recipes.add(createRecipe(500, 1, new ItemStack(Material.PIG_SPAWN_EGG)));
                    recipes.add(createRecipe(500, 1, new ItemStack(Material.POLAR_BEAR_SPAWN_EGG)));
                    recipes.add(createRecipe(500, 1, new ItemStack(Material.PUFFERFISH_SPAWN_EGG)));
                    recipes.add(createRecipe(500, 1, new ItemStack(Material.RABBIT_SPAWN_EGG)));
                    recipes.add(createRecipe(500, 1, new ItemStack(Material.SALMON_SPAWN_EGG)));
                    recipes.add(createRecipe(500, 1, new ItemStack(Material.SHEEP_SPAWN_EGG)));
                    recipes.add(createRecipe(500, 1, new ItemStack(Material.SKELETON_HORSE_SPAWN_EGG)));
                    recipes.add(createRecipe(500, 1, new ItemStack(Material.SQUID_SPAWN_EGG)));
                    recipes.add(createRecipe(500, 1, new ItemStack(Material.STRIDER_SPAWN_EGG)));
                    recipes.add(createRecipe(500, 1, new ItemStack(Material.TRADER_LLAMA_SPAWN_EGG)));
                    recipes.add(createRecipe(500, 1, new ItemStack(Material.TROPICAL_FISH_SPAWN_EGG)));
                    recipes.add(createRecipe(500, 1, new ItemStack(Material.TURTLE_SPAWN_EGG)));
                    recipes.add(createRecipe(500, 1, new ItemStack(Material.VILLAGER_SPAWN_EGG)));
                    recipes.add(createRecipe(500, 1, new ItemStack(Material.WANDERING_TRADER_SPAWN_EGG)));
                    recipes.add(createRecipe(500, 1, new ItemStack(Material.WOLF_SPAWN_EGG)));
                    recipes.add(createRecipe(500, 1, new ItemStack(Material.ZOMBIE_HORSE_SPAWN_EGG)));
                    villager.setRecipes(recipes);
